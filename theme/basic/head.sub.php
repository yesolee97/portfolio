...
<?php
add_javascript('<script src="'.G5_THEME_JS_URL.'/lib/jquery.min.js"></script>', 0);
...
add_javascript('<script src="'.G5_THEME_JS_URL.'/lib/bootstrap.min.js"></script>', 0);
add_javascript('<script src="'.G5_THEME_JS_URL.'/lib/swiper-bundle.min.js"></script>', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_JS_URL.'/font-awesome/css/font-awesome.min.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/lib/bootstrap.min.css">', 0);
add_stylesheet('<link rel="stylesheet" href="'.G5_THEME_CSS_URL.'/lib/swiper-bundle.min.css">', 0);
...
=======
    <!-- 3.25 플러그인 추가 (scrollmagic, gsap 호환성 제공) -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.8/plugins/animation.gsap.min.js"></script>
    <script src="https://cdnjs.cloudflare.com/ajax/libs/ScrollMagic/2.0.8/plugins/debug.addIndicators.min.js"></script>
