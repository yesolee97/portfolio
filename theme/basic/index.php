						...
						<div class="project-col-wr row mt-5 gx-5">
							...
							<div class="project-col-txt-wrap col-xl-6 col-12">
								<div class="project-col-txt-box mb-3">
									...
									<!-- <p>
										기존 정부로부터 무상으로 지원받아 사용중이였던 '표준기록관리시스템'의 문제점 개선을 위해 HTML5 웹 기반 시스템으로 전환해 사용자 편의성을 향상하고 보완취약점을 해소하는 데 중점을 두고 개발이 진행되었습니다.
									</p> -->
									<p>
										<b>사내 2명의 퍼블리셔가 약 12개월, 1명의 외부 퍼블리셔가 약 3개월 동안 함께 했으며,</b> 각 파트별 <b>프로그래머와 협업하는 과정을 통해 두번 작업하지 않는 보다 효율적인 작업 방식에 대한 고민을 많이 할 수 있는 계기</b>가 되었습니다. <b>한눈에 알아보기 쉬운 직관적인 클래스 명, 주석 등의 중요성</b>을 깨달을 수 있었습니다.
									</p>
									<p>
										기존 UI/UX가 반영되지 못한 디자인에서 좀 더 사용자 친화적인 UI/UX 디자인으로 개선 후 샘플페이지 코딩 및 검수, 시스템별 화면 설계, 페이지 개발을 추진하였습니다.
									</p>
									<p>
										해당 프로젝트를 통해 UI/UX 플랫폼인 <b>SOFTBOWL - SBUx</b>와, 웹 DataGrid UI 라이브러리인 <b>RealGrid</b>를 사용해 개발을 진행하는 경험을 쌓고, 그 과정에서 
									</p>
								</div>
								<div class="">
									<div class="row">
